...
####
####
####  Structural Topic Modeling - sample test
####
####
####
###############################
...
stm_brasil <- stm(prep_brasil_docs, prep_brasil_vocab, topics)
...
stm_paraguay <- stm(prep_paraguay_docs, prep_paraguay_vocab, topics)
